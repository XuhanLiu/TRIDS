...
Optionally, also check **PyTrids** if installed:
      ...
      $ python tests/test_pytrids.py -g 0 (CUDA)
      $ python tests/test_pytrids.py -g -1 (CPU)
...
Options:
      ...
      pocket      = str:      PyMOL selection PyMOL selection generated by trisite
      ligand      = str:      PyMOL selection or file path (sdf/mol2/pdb) for the ligand
      output      = str:      (optional) output file path for docked poses
