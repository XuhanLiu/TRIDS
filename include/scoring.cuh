...
class TriAccurateScoring : public Function<TriAccurateScoring> {

public:
    static at::Tensor forward(AutogradContext* ctx, at::Tensor pos,
                              TriScorer* scorer);

    static tensor_list backward(AutogradContext* ctx, tensor_list grad_outputs);
};

class TriFastScoring : public Function<TriFastScoring> {
...
class VinaAccurateScoring : public Function<VinaAccurateScoring> {
public:
    static at::Tensor forward(AutogradContext* ctx, at::Tensor pos,
                              VinaScorer* scorer);
...
class VinaFastScoring : public Function<VinaFastScoring> {
public:
    static at::Tensor forward(AutogradContext* ctx, at::Tensor pos,
                              VinaScorer* scorer);
